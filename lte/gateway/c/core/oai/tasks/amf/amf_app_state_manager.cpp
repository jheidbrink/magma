...
void AmfNasStateManager::create_state() {
  ...
  state_cache_p->amf_ue_contexts.imsi_amf_ue_id_htbl.set_name(AMF_IMSI_UE_ID_TABLE_NAME);
  state_cache_p->amf_ue_contexts.tun11_ue_context_htbl.set_name(AMF_TUN_UE_ID_TABLE_NAME);
  state_cache_p->amf_ue_contexts.gnb_ue_ngap_id_ue_context_htbl.set_name(AMF_GNB_UE_ID_AMF_UE_ID_TABLE_NAME);
  state_cache_p->amf_ue_contexts.guti_ue_context_htbl.set_name(AMF_GUTI_UE_ID_TABLE_NAME);
  create_hashtables();
